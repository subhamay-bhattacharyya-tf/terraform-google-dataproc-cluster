...
| `machine_type` | `string` | `n1-standard-4`, `n1-highmem-8`, `n1-highcpu-8`, etc. |
...
### Example: Dataproc Cluster Module

```hcl
variable "dataproc_cluster_config" {
  description = "Configuration for the Google Dataproc cluster."
  type = object({
    base_name                          = string
